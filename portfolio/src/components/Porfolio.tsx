  ...
  return (
    <div>
        <div className='bg-[#1C1C1C] max-lg:h-[110px] h-[220px] rounded-sm'>
            ...
            Copywriting, Blogging, Email Marketing, Content Strategy</p>
        </div>
        ...
        <div className='mx-10 my-8 flex flex-col md:flex-row gap-5'>
            <div className='w-full h-full'>
                ...
                <p className="text-gray-400 text-lg  text-center">Samples of Articles I have created for various brands over the years. </p> 
            </div>
      
            <div className='w-full h-full'>
                <Image src='/portfolio2.jpg' width={600} height={600} alt="hh"  />
                <h1 className= "text-2xl md:text-3xl my-4 text-center">Social Media Marketing</h1>
                <p className="text-gray-400 text-lg text-center">Samples of social media posts I have created in my past campaigns</p> 
            </div>
        </div>
