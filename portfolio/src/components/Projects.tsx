  ...
  return (
    <div>
        ...
        <div className='mx-10 my-8 flex flex-col md:flex-row gap-5'>
            <Link href='/Portfolio/Content' className='w-full h-full'>
                ...
                <button className='bg-[#00c9c8] text-black text-xl font-semibold px-4 py-1 mb-3'><a href='/Portfolio/Content'>Explore</a></button>
                </div> 
            </Link>
      
            <Link href='/Portfolio/Emails' className='w-full h-full'>
                ...
                <div className='flex justify-center mt-5 mb-2'>
                <button className='bg-[#00c9c8] text-black text-xl font-semibold px-4 py-1 mb-3'><a href='/Portfolio/Emails'>Explore</a></button>
                </div> 
            </Link>
        </div>
